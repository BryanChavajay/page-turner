...
export const FinishedBook = ({ id, title, finishedDate, author }) => {
    ...
    >
      <div className="flex gap-4 p-4">
        ...
        <div className="flex-1 min-w-0">
          <span className="inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap gap-1 overflow-hidden border-green-200 bg-green-100 mb-2">
            Terminado
          </span>
          <h3>{title}</h3>
          <p>{author}</p>
